...
展开态（练习时）：
┌──────────────────────────────────────────────────────────┐
│ 🎹 清谱 v2.0  [曲谱▼] [标准|锚线|七色] [浏览|跟弹|视奏] │ ← 顶部栏 48px
│ BPM 120 [──●──]  缩放 100% [─●─]                    [▲] │   [▲] 折叠按钮
├──────────────────────────────────────────────────────────┤
│                                                           │
│                                                           │
...
│                                                           │
├──────────────────────────────────────────────────────────┤
│ 连击: 0  完美: 0  良好: 0  偏差: 0  准确率: --%          │ ← 统计条 32px
├──────────────────────────────────────────────────────────┤
│ 🎹 │█│ │█│ │█│ │█│ │█│ │█│ │█│ │█│ │█│ │█│ │█│ ... [▼] │ ← 虚拟键盘 120px
└──────────────────────────────────────────────────────────┘
...
**布局原则**：
- **顶部栏（48px，可折叠→8px）**：Logo + 曲谱选择 + 显示模式 + 练习模式 + BPM + 缩放，点击 [▲] 收起为细条
- **乐谱区（自适应剩余空间）**：绝对主角，全宽展示，折叠后接近全屏沉浸
- **统计条（32px）**：一行显示连击/完美/良好/偏差/准确率，始终可见
- **虚拟键盘（120px，可折叠→8px）**：钢琴键布局，点击 [▼] 收起为细条
- **折叠交互**：顶部和底部独立折叠，悬停细条时显示展开按钮，练习时键盘自动展开
